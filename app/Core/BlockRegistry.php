...
class BlockRegistry
{
    ...
    private static function lBrand(array $data): string
    {
        ...
        // Kein eigenes Logo im Block? Dann das Logo der Website aus den
        // Einstellungen nehmen – so zeigen Baukasten- und HTML-Layouts dasselbe.
        $logo = trim((string) ($data['logo'] ?? '')) ?: trim((string) \Models\Setting::get('site_logo', ''));
        if ($logo !== '') {
