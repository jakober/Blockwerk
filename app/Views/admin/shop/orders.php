        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($orders as $o): ?>
                    <tr>
                        <td data-label="Nr."><a href="<?= e(url('/admin/shop/orders/' . $o['id'])) ?>"><strong><?= e($o['number']) ?></strong></a></td>
                        <td class="muted small" data-label="Datum"><?= e(format_date_de($o['created_at'], true)) ?></td>
                        <td data-label="Kunde"><?= e(trim(($o['first_name'] ?? '') . ' ' . ($o['last_name'] ?? '')) ?: $o['email']) ?></td>
                        <td data-label="Summe"><?= e(\Core\Shop::formatPrice((int) $o['total'])) ?></td>
                        <td class="small" data-label="Zahlung"><?= e($o['payment_method'] ?? '–') ?> · <?= (int) ($o['payment_status'] === 'paid') ? '<span class="badge badge-green">bezahlt</span>' : '<span class="badge badge-amber">offen</span>' ?></td>
                        <td data-label="Status"><span class="badge <?= $statusBadge[$o['status']] ?? 'badge' ?>"><?= e($statusLabels[$o['status']] ?? $o['status']) ?></span></td>
