...
<header class="t-header">
  <div class="container t-brandwrap"><a class="t-brand" href="{{base_url}}/">{{logo}}{{site_name}}</a></div>
...
<header class="t-header">
  <div class="container t-headerbar">
    <a class="t-brand" href="{{base_url}}/">{{logo}}{{site_name}}</a>
...
.t-brand{display:inline-flex;align-items:center;gap:10px;font-size:21px;font-weight:800;letter-spacing:-.4px;color:inherit;text-decoration:none}
.t-brand .site-logo,.site-logo{height:40px;width:auto;display:block}
