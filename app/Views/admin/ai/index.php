<?php if (!$configured): ?>
    <div class="card narrow ai-setup">
        ...
        Zum Aktivieren brauchst du einen <strong>Lizenzschlüssel</strong> (beginnt mit <code>bw-</code>) mit Token-Guthaben.</p>
        <ol class="muted small" style="text-align:left;max-width:520px;margin:0 auto 18px;line-height:1.7">
            <li><strong>Guthaben kaufen:</strong> Öffne die <a href="<?= e($buyUrl) ?>" target="_blank" rel="noopener">Kaufseite</a>, wähle ein Paket und zahle. Deinen Schlüssel bekommst du sofort per E-Mail.</li>
            <li><strong>Schlüssel eintragen:</strong> Unter <a href="<?= e(url('/admin/settings')) ?>#ki">Einstellungen → KI-Assistent</a> ins Feld „Lizenzschlüssel“ einfügen und speichern.</li>
            <li><strong>Loslegen:</strong> Danach zeigt diese Seite dein Guthaben – beschreibe einfach, was die KI bauen soll.</li>
        </ol>
        <a class="btn btn-primary" href="<?= e(url('/admin/settings')) ?>#ki">Schlüssel eintragen</a>
        <?php if ($buyUrl !== ''): ?><a class="btn btn-ghost" href="<?= e($buyUrl) ?>" target="_blank" rel="noopener" style="margin-left:8px">Guthaben kaufen ↗</a><?php endif; ?>
    </div>
<?php else: ?>
