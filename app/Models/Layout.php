...
class Layout
{
    ...
    /** Nur das Layout-HTML aktualisieren (klassische Layouts). */
    public static function saveHtml(int $id, string $html): void
    {
        Database::pdo()->prepare('UPDATE layouts SET html = ? WHERE id = ?')->execute([$html, $id]);
    }
