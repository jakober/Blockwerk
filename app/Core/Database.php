...
class Database
{
    ...
    /**
     * Verwirft die gecachte Verbindung, sodass der nächste pdo()-Aufruf mit der
     * aktuellen Konfiguration neu verbindet.
     */
    ...
    /** Spalte anlegen, falls sie fehlt – auch von Models genutzt (Selbstheilung). */
